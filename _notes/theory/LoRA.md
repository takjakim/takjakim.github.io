...
## 쉬운 설명
LoRA는 "Low-Rank Adaptation"의 약자이다. 이름이 어려워 보이지만, 핵심 아이디어는 매우 간단해요.
...
LoRA는 거대 모델의 **핵심 부분(W)은 그대로 두고**, **작은 업데이트 행렬(A, B)만 학습**한다.
...
## R4 연구에서의 역할
R4 연구는 **LoRA를 사용하여 Fine-tuning**을 진행한다. 왜냐하면:
