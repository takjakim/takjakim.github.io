---
title: "해이링 2일차: 대화 이어가기(걷기/날씨/경복궁/일) 자연스러운 문장 7개"
...
핵심: 미세먼지는 `heavy`가 아니라 **bad / severe / terrible** 쪽이 자연스럽다.
...
핵심: 경복궁은 `castle`보다 **royal palace**가 정확.
...
- `40 or 1 hour` → **40 minutes to an hour**
...
핵심: `too many tourists`를 말할 때는 `crowded` 한 단어가 대화를 훨씬 자연스럽게 만든다.
...
핵심:
- `too risk` → **at risk**
- `many regions universities` → **many regional universities**
